...
# chmod +x $TRAVIS_BUILD_DIR/code_docs/doxypypy/doxypypy/doxypypy.py

# mv /usr/local/local/bin/doxypy.py /usr/local/bin
...
# rm -r -f $TRAVIS_BUILD_DIR/code_docs/doxypypy
